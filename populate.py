...
nonfiction2 = Tome_Rater.create_non_fiction("Computing Machinery and Intelligence", "AI", "advanced", 1111193899, 110.00)
novel2 = Tome_Rater.create_novel("The Diamond Age", "Neal Stephenson", 1010101010, 15.25)
novel3 = Tome_Rater.create_novel("There Will Come Soft Rains", "Ray Bradbury", 1000100011, 21.50)
